...
| 文件 | 版本 | 行数 | 状态 | 说明 |
|------|------|------|------|------|
| `01_PRODUCT_VISION.md` | 1.0 | 82 | 可用 | Phase 1 够用，Phase 2 需更新 |
| `02_DEVELOPMENT_ROADMAP.md` | 1.0 | 157 | 需更新 | 路线已变化，Phase 拆分需重排 |
| `03_SYLLABUS_SOURCE_RULES.md` | 1.0 | 90 | 可用 | 规则自洽，大纲已按此产出 |
| `04_KNOWLEDGE_LEVELING.md` | 1.0 | 58 | 可用 | 四档 ABCD 已对齐新课标 |
| `05_COVERAGE_GATE.md` | 1.0 | 153 | 可用 | 规则完备，门禁脚本已实现 |
| `06_KNOWLEDGE_GRAPH.md` | 1.0 | 73 | 可用 | 两层架构，数据已全量建成 |
| `07_ERROR_TAXONOMY.md` | 1.0 | 92 | 需扩充 | 规则骨架在，缺少反证/验证详解 |
| `08_STRATEGY_PACKS.md` | 2.0 | 280+ | 就绪 ✅ | 39 包 + 编码体系 + 映射表 |
| `09_EVENT_PROTOCOL.md` | 2.0.6 | 913 | 就绪 ✅ | 11 事件 + 链式追踪 + 数据底座对齐 |
| `10_DATA_MODEL.md` | 2.0 | 300+ | 就绪 ✅ | 10 张表完整 Schema + 数据文件清单 |
| `11_DIAGNOSIS_ENGINE.md` | 2.3 | 568 | 就绪 ✅ | 四步诊断 + 六态 + 地狱审计 0 阻断 |
| `12_STRATEGY_ENGINE.md` | 2.0 | 280+ | 就绪 ✅ | 六态调度 + 安全护栏 + 体验保护 |
| `13_PARENT_SUMMARY_RULES.md` | 2.0 | 200+ | 就绪 ✅ | 模板体系 + 风险评分 + 家长反馈闭环 |
| `14_QUALITY_DASHBOARD.md` | 2.0 | 240+ | 就绪 ✅ | 24 指标 + 9 铁规集成 + top 10 算法 |
...
**规则层：80%**（14 份规划文档中：8 份就绪 + 4 份可用 + 2 份需更新）
