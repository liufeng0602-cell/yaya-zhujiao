...
|------|-----------|------|---------------------|-------------|
| 外部法规定义 | 禁止词列表（4.1） | 家长端安全底线。17 词 + 7 模式由教研团队和儿童心理顾问共同制定，涉及儿童心理保护和社会评价 | 删除「粗心」一词后，家长摘要出现该词→家长投诉→品牌信任受损，不可逆 | 如需要新增/删除禁止词，必须经教研人员 + 儿童心理顾问双签批。AI 可以建议但不可以直接修改 |
